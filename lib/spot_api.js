...
SpotApi.prototype.walletInfo = function(){
    return this.api.query('wallet_info.do', {})
}
SpotApi.prototype.fundsTransfer = function(symbol, amount, from, to){
    return this.api.query('funds_transfer.do', {
        symbol: symbol,
        amount: amount,
        from: from,
        to: to,
